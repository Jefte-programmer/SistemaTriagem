...
O Sistema de Triagem Hospitalar JKJ (feito em parceria com colegas de sala, para um trabalho da disciplina de POO) é uma aplicação desenvolvida com o objetivo de realizar uma classificação prévia dos sintomas de pacientes, permitindo identificar o nível de risco antes mesmo do atendimento presencial.
